...
#Importing random to give 2 and 4, 75% to get 2 and 25% to get 4
#No tests can be done
#Импортируем функцию рандома чтобы игра выдавала 2 и 4,
#75% на то что выпадет 2 и 25% на то что выпадет 4
#Тестировать нельзя из-за рандома
